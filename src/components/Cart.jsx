...
export default function Cart() {
    ...
    return (
        <section className="min-h-[100vh] text-center mt-10">
            ...
            <div className='my-7'>
                {cartItems.length > 0 ? <Button variants={'bg-red-500 hover:bg-red-400 active:bg-red-600 text-white font-bold ml-4 flex'} onClick={handleClearCartItem}>Clear Cart</Button> : <p className='text-xl text-gray-500'>Your cart is empty! Please add items to cart</p>}
