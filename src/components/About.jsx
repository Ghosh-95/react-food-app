...
export default class About extends Component {
    ...
    render() {
        return (
            <section className="w-[30rem] bg-gradient-to-t from-green-500 to-green-600 mx-auto my-[5rem] flex justify-center flex-col px-12 py-[1.2rem] text-white rounded-md shadow-md">
